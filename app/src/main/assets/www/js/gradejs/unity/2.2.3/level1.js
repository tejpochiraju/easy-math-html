Game.unity2_2_3level1=function(){};


Game.unity2_2_3level1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'unity2_2_3_BG_01');
        
        _this.navBar = _this.add.sprite(0,0,'unity2_2_3_navBar');
        _this.navBar.scale.setTo(1,1);
        
        _this.backbtn = _this.add.button(5,5,'unity2_2_3_backbtn',function(){ 
        ...
        _this.speakerbtn = _this.add.sprite(600,5,'unity2_2_3_CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(300,5,'unity2_2_3_timebg');
       /* _this.topicOutline = _this.add.sprite(70,5,'unity2_2_3_topicOutline');
        _this.practice = _this.add.sprite(78,10,'unity2_2_3_practice');
        _this.topic = _this.add.sprite(200,10,'unity2_2_3_topic');*/
       ...
       /* _this.playQuestionSound = document.createElement('audio');
        ...
        {
            _this.src.setAttribute("src", "questionSounds/2.2.3/English/2.2.mp3");
        }
        else if(window.languageSelected=="Hindi")
        {
            _this.src.setAttribute("src", "questionSounds/2.2.3/Hindi/2.2.mp3");
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.src.setAttribute("src", "questionSounds/2.2.3/Kannada/2.2.mp3");
        }
		else 
        {
            _this.src.setAttribute("src", "questionSounds/2.2.3/Odiya/2.2.3.mp3");
        }
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'unity2_2_3_starAnim');
			for(var j =0;j<i;j++)
			{
    ...
    onDragStart:function(target)
    {
       //console.log("onDragStart");
        ...
        { 
            ...
            event_type: "drag", 
            res_id: "level2.2.3_"+target.name, 
        ...
        target.events.onDragStop.add(function(target)
        {
            ...
            {
                if(_this.checkOverlap(target,_this.CaterpillarWhite.getChildAt(i)) && (_this.whiteGroup.getChildAt(i).key == 'unity2_2_3_Caterpillar_body3'))
                { 
    ...
    dragStop:function(target)
    {
        ...
        for(var i=0;i<_this.whiteGroup.length;i++)
        {
            ...
            { 
                ...
                target.loadTexture('unity2_2_3_Caterpillar_body3',0,false);
    ...
    {  
        ...
        _this.Caterpillar_body_head_1= _this.add.sprite(_this.world.centerX-70,_this.world.centerY-40,'unity2_2_3_Caterpillar_body3');
        _this.Caterpillar_body_head_1.anchor.setTo(0.5);
        _this.Caterpillar_body_head_1.scale.setTo(0.55,0.55);
       
        _this.Caterpillar_body_head_2= _this.add.sprite(_this.world.centerX+10,_this.world.centerY-30,'unity2_2_3_Caterpillar_body3');
        _this.Caterpillar_body_head_2.anchor.setTo(0.5);
        _this.Caterpillar_body_head_2.scale.setTo(0.55,0.55);
        
        _this.Caterpillar_body_head_3= _this.add.sprite(_this.world.centerX+90,_this.world.centerY-35,'unity2_2_3_Caterpillar_body3');
        _this.Caterpillar_body_head_3.anchor.setTo(0.5);
        _this.Caterpillar_body_head_3.scale.setTo(0.55,0.55);
        
        _this.Caterpillar_body_head_4= _this.add.sprite(_this.world.centerX+170,_this.world.centerY-28,'unity2_2_3_Caterpillar_body3');
        _this.Caterpillar_body_head_4.anchor.setTo(0.5);
        _this.Caterpillar_body_head_4.scale.setTo(0.55,0.55);
        
        /***********************************Copy*****************************************/
        _this.Caterpillar_body_head_1Copy= _this.add.sprite(_this.world.centerX-70,_this.world.centerY-40,'unity2_2_3_Caterpillar_body3');
        _this.Caterpillar_body_head_1Copy.anchor.setTo(0.5);
        _this.Caterpillar_body_head_1Copy.scale.setTo(0.55,0.55);
       
        _this.Caterpillar_body_head_2Copy= _this.add.sprite(_this.world.centerX+10,_this.world.centerY-30,'unity2_2_3_Caterpillar_body3');
        _this.Caterpillar_body_head_2Copy.anchor.setTo(0.5);
        _this.Caterpillar_body_head_2Copy.scale.setTo(0.55,0.55);
        
        _this.Caterpillar_body_head_3Copy= _this.add.sprite(_this.world.centerX+90,_this.world.centerY-35,'unity2_2_3_Caterpillar_body3');
        _this.Caterpillar_body_head_3Copy.anchor.setTo(0.5);
        _this.Caterpillar_body_head_3Copy.scale.setTo(0.55,0.55);
        
        _this.Caterpillar_body_head_4Copy= _this.add.sprite(_this.world.centerX+170,_this.world.centerY-28,'unity2_2_3_Caterpillar_body3');
        ...
        _this.Caterpillar_head= _this.add.sprite(_this.world.centerX-160,_this.world.centerY-85,'unity2_2_3_start');  
        _this.Caterpillar_head.name = "start";
        _this.Caterpillar_head.anchor.setTo(0.5);
        _this.Caterpillar_head.scale.setTo(0.6,0.6);
        
        _this.Neutral =_this.Caterpillar_head.animations.add('unity2_2_3_start');
        _this.Caterpillar_head.animations.play('unity2_2_3_start', 20, true);
     
        _this.opt1 = _this.add.sprite(_this.world.centerX+370,_this.world.centerY-10, 'unity2_2_3_Tick');
        ...
        _this.Caterpillar_body_head_5= _this.add.sprite(_this.world.centerX-170,_this.world.centerY+130,'unity2_2_3_Caterpillar_Body1');
        ...
        _this.text = _this.add.text(0, 0, "569");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.Caterpillar_body_head_6= _this.add.sprite(_this.world.centerX-55,_this.world.centerY+130,'unity2_2_3_Caterpillar_Body2');
        ...
        _this.text = _this.add.text(0, 0, "568");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.Caterpillar_body_head_7= _this.add.sprite(_this.world.centerX+60,_this.world.centerY+130,'unity2_2_3_Caterpillar_Body1');
        ...
        _this.text = _this.add.text(0, 0, "567");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.Caterpillar_body_head_8= _this.add.sprite(_this.world.centerX+180,_this.world.centerY+130,'unity2_2_3_Caterpillar_Body2');
        ...
        _this.text = _this.add.text(0, 0, "566");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    {                                  
       ...
       // _this.opt1.frame=1;
        ...
        _this.text = _this.add.text(0, 0, "115");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoThirdQuestion:function()
    {
       ...
       // _this.opt1.frame=1;
        ...
        _this.text = _this.add.text(0, 0, "247");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "244");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "245");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "246");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoFourthQuestion:function()
    {
        ...
        _this.Neutral =_this.Caterpillar_head.animations.add('unity2_2_3_start');
        _this.Caterpillar_head.animations.play('unity2_2_3_tart', 20, true);
        ...
        _this.text = _this.add.text(0, 0, "372");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "371");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoFifthQuestion:function()
    {
        ...
        _this.opt1 = _this.add.sprite(_this.world.centerX+347,_this.world.centerY-10, 'unity2_2_3_Tick');
    	_this.opt1.anchor.setTo(0.5);
        _this.opt1.scale.setTo(1.4,1.4);
        //_this.opt1.frame=1;
        _this.opt1.name = 'tick1';
        ...
        _this.text = _this.add.text(0, 0, "427");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "428");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "429");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "426");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoSixthQuestion:function()
    {
       ...
       // _this.opt1.frame=1;
        ...
        _this.text = _this.add.text(0, 0, "534");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "533");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "535");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoSeventhQuestion:function()
    {
       ...
       // _this.opt1.frame=1;
        ...
        _this.text = _this.add.text(0, 0, "686");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "689");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "688");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "687");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoEighthQuestion:function()
    {
        ...
        _this.text = _this.add.text(0, 0, "755");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "754");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "753");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "752");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoNinethQuestion:function()
    {
        ...
        _this.text = _this.add.text(0, 0, "891");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "894");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "893");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "892");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    {                                  
        ...
        _this.text = _this.add.text(0, 0, "903");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "904");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "902");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
...
//                
        ...
        if(correct)
        {
            ...
            if (_this.Caterpillar_head.key == 'unity2_2_3_start')
            {
                _this.Caterpillar_head.loadTexture('unity2_2_3_Caterpillar_Happy', 0);
                _this.Caterpillar_head.animations.add('unity2_2_3_Caterpillar_Happy');
                _this.Caterpillar_head.animations.play('unity2_2_3_Caterpillar_Happy',20,true);
            }
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'unity2_2_3_start')
            {
                _this.Caterpillar_head.loadTexture('unity2_2_3_wrong', 0);
                _this.Caterpillar_head.animations.add('unity2_2_3_wrong');
                _this.Caterpillar_head.animations.play('unity2_2_3_wrong',20,true);
            }
   ...
   /* wrongAns:function(target)
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_2_3Score');
        }
