Game.unity2_1_2level1=function(){};


Game.unity2_1_2level1.prototype ={
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'unity2_1_2_starAnim');
			for(var j =0;j<i;j++)
			{
    ...
    wrongAns:function(target)
	{
        ...
        {
            _this.Caterpillar_head1.loadTexture('Cunity2_1_1_aterpillar_Sad', 0, false);
        }
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_1_2Score');
        }
    },
