Game.unity2_3_2alevel1=function(){};

Game.unity2_3_2alevel1.prototype ={
    
    init:function(game)
    {
        _this= this;
        //telInitializer.gameIdInit("sequence2_3_2a",gradeSelected);
    },
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Unity2_3_2aBG_01');
    ...
    {  
        ...
        //_this.Caterpillar_head.animations.play('Unity2_3_2astart', 30, true);
     
        _this.opt1 = _this.add.sprite(_this.world.centerX+373,_this.world.centerY-30, 'Unity2_3_2aTick');
    	_this.opt1.anchor.setTo(0.5);
        _this.opt1.scale.setTo(1.5,1.5);
        ///_this.opt1.frame = 1;
        _this.opt1.name="Unity2_3_2aTick1";
	...
	correctAns:function(target)
	{
        ...
        {   
            ...
            {
                _this.Caterpillar_head.loadTexture('Unity2_3_2aCaterpillar_Happy', 0);
                _this.Caterpillar_head.animations.add('Unity2_3_2aCaterpillar_Happy');
                _this.Caterpillar_head.animations.play('Unity2_3_2aCaterpillar_Happy',null,true);
            }
        ...
        { 
            ...
            if (_this.Caterpillar_head.key == 'Unity2_3_2astart')
            {
                ...
                _this.Caterpillar_head.loadTexture('Unity2_3_2awrong', 0);
                _this.Caterpillar_head.animations.add('Unity2_3_2awrong');
                _this.Caterpillar_head.animations.play('Unity2_3_2awrong',null,true);
            }
  ...
  /*  wrongAns:function(target)
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_3_2aScore');
        }
    },
