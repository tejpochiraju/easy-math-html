...
Game.unity14_2level1.prototype={
    ...
    {  
       ...
       /**************************************************************************/ 
        ...
        //_this.gridh1.scale.setTo(1.5,1.5);
        
        
        //_this.gridv1.scale.setTo(1.5,1.5);
  ...
  return array;
       ...
       /* if(_this.firstno == 11){
        ...
        for(var yellowh=0;yellowh<_this.addyellowh;yellowh++){
         ...
         //   _this.yellowgrid1 = this.add.sprite(470+(yellowh*23),80,'Level14_yellowgrid');
           // _this.yellowgrid1.scale.setTo(1.1,1.1); 
        ...
        for(var yellowv=0;yellowv<_this.addyellowv;yellowv++){
         ...
         //   _this.yellowgrid2 = this.add.sprite(210,352+(yellowv*20),'Level14_yellowgrid');
    ...
    getVoice:function(){
        ...
        {
            _this.src.setAttribute("src", "questionSounds/14.2/English/Game 14.2.mp3");
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.src.setAttribute("src", "questionSounds/14.2/Hindi/Game 14.2.mp3");
        }
        else if(window.languageSelected == "Kannada")
        {
            _this.src.setAttribute("src", "questionSounds/14.2/Kannada/Game 14.2.mp3");
        }else{
            _this.src.setAttribute("src", "questionSounds/14.2/Odiya/14.2.mp3");
   ...
   addNumberPad:function(){
    ...
    onDragStop:function(target){//_this.Level14_gridjointvadd  groupvertical
        _this.snapSound.play();
            //console.log("_this.countgreen=="+_this.countgreen);
                if(_this.countgreen<2){
                   //console.log("y ====="+target.y);
                 if((target.x > 50 && target.x < 620) && (target.y > 30 && target.y < 420)){
                        ...
                        //console.log("it isooo"+_this.countgreenh);
                        _this.countgreenh++;
        ...
        if(_this.flag=="question2" && target.name == "vertical"){
           //console.log("in vertimmmmmmmmmmmmmmmmmmmmmmmm");
            /*_this.countvno++;
            
            if(_this.countvno==1){
                target.scale.setTo(1.47,1.45);
                target.x=210;
                target.y=105;
            }else{*/
                target.x=118;
        ...
        if(target.name=="vertical" && _this.flag=="question1"){
           // //console.log("vertical len=="+_this.verticalcount);
            ...
            }else if(this.checkOverlap(target,groupvertical.getChildAt(6)) ){
                /*_this.countvno++;
                if(_this.countvno==1){
                    target.scale.setTo(1.47,1.45);
                    target.x=210;
            ...
            }else if(this.checkOverlap(target,groupvertical.getChildAt(7)) ){
                /*_this.countvno++;
                if(_this.countvno==1){
                    target.scale.setTo(1.47,1.45);
                    target.x=210;
            ...
            if(_this.dragv==0 && _this.dragv < _this.addyellowh){
                ...
                _this.verticallen++;
                    ...
                    _this.verticalcount=target.x;
                    _this.verticallen++;
                }else if(_this.dragv==5 && _this.dragv < _this.addyellowh){
                    target.scale.setTo(1.67,1.65);
                    target.y = 107;
                    target.x=586;
                    _this.verticalcount=target.x;
                    _this.verticallen++;
                }else if(_this.dragv==6 && _this.dragv < _this.addyellowh){
                    target.scale.setTo(1.67,1.65);
                    target.y = 107;
                    target.x=610;
                    _this.verticalcount=target.x;
                    _this.verticallen++;
                }else if(_this.dragv==7 && _this.dragv < _this.addyellowh){
                    target.scale.setTo(1.67,1.65);
                    target.y = 107;
                    target.x=634;
                    _this.verticalcount=target.x;
         ...
         //  }//orange
              ...
              /*if(_this.greencubesets==0){
                  ...
                  target.y=250;
                          ...
                          //console.log("counthno=="+_this.counthno);
                         /* if(_this.dragh == -1){
                                //console.log("no drag found");
                                target.x=52;
                                target.y=250;
                    ...
                    if(this.checkOverlap(target,grouphorizontal.getChildAt(0)) ){
                        ...
                        _this.counthno++;
                        //console.log("in if===========================>"+_this.counthno);
                        //console.log("in if cubesets===========================>"+_this.greencubesets);
                        /*if(_this.counthno==1){
             ...
             //console.log("drag here=========================="+_this.dragh);
              //console.log("drag here _this.addyellowv=========================="+_this.addyellowv);
            
            if(_this.dragh==0 && _this.dragh < _this.addyellowv){       
                //console.log("drag1 again");///////240 105
                target.scale.setTo(1.67,1.73);
                    target.y = 346;
                    target.x=235;
...
//                }
            ...
            target.inputEnabled=false;
             /* _this.dragh++;
              ...
              //console.log("question1 yellowgrid"+_this.countyellowno2);
              //console.log("target x =="+target.x);
              //console.log("target y =="+target.y);
              //console.log("_this.addyellowh =="+_this.addyellowh);
             //console.log("_this.addyellowv =="+_this.addyellowv);
             
              if(_this.countyellowno<=_this.addyellowh){   
                  //console.log("_this.addyellowh again =="+_this.addyellowh);
                  ...
                  //console.log("_this.colorange2 =="+_this.colorange2);
                  //console.log("_this.addyellowv again =="+_this.addyellowv);
...
//                                  _this.colg=_this.col;
           ...
           /* if(this.checkOverlap(target,graphicsvertical) || this.checkOverlap(target,_this.Level14_gridjointhadd)){
            ...
            //console.log("horiz count===="+_this.horizontalcount);
                //console.log("verti count===="+_this.verticalcount);
