Game.unity2_4_1alevel1=function(){};

Game.unity2_4_1alevel1.prototype ={
    
    init:function(game)
    {
        _this= this;
        //telInitializer.gameIdInit("sequence2_4_1a",gradeSelected);
    },
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Unity2_4_1a_BG_01');
    ...
    onDragStart:function(target)
    {
       //console.log("onDragStart");
        ...
        target.events.onDragStop.add(function(target)
        {
            ...
            {
                if(_this.checkOverlap(target,_this.CaterpillarWhite.getChildAt(i)) && (_this.whiteGroup.getChildAt(i).key == 'Unity2_4_1a_Caterpillar_body3'))
                { 
    ...
    dragStop:function(target)
    {
        ...
        for(var i=0;i<_this.whiteGroup.length;i++)
        {
            ...
            { 
                ...
                target.loadTexture('Unity2_4_1a_Caterpillar_body3',0,false);
    ...
    {  
        ...
        _this.Caterpillar_body_head_1_1= _this.add.sprite(_this.world.centerX-65,_this.world.centerY-32,'Unity2_4_1a_Caterpillar_Body2');
        ...
        //White color body
        _this.Caterpillar_body_head_1= _this.add.sprite(_this.world.centerX-130,_this.world.centerY-20,'Unity2_4_1a_Caterpillar_body3');
        _this.Caterpillar_body_head_1.anchor.setTo(0.5);
        _this.Caterpillar_body_head_1.scale.setTo(0.7,0.7);
        
        _this.Caterpillar_body_head_2= _this.add.sprite(_this.world.centerX,_this.world.centerY-20,'Unity2_4_1a_Caterpillar_body3');
        _this.Caterpillar_body_head_2.anchor.setTo(0.5)
        _this.Caterpillar_body_head_2.scale.setTo(0.7,0.7);
        
        /***********************************Copy*****************************************/
        _this.Caterpillar_body_head_1Copy=_this.add.sprite(_this.world.centerX-130,_this.world.centerY-20,'Unity2_4_1a_Caterpillar_body3');
        _this.Caterpillar_body_head_1Copy.anchor.setTo(0.5);
        _this.Caterpillar_body_head_1Copy.scale.setTo(0.7,0.7);
       
        _this.Caterpillar_body_head_2Copy=_this.add.sprite(_this.world.centerX,_this.world.centerY-20,'Unity2_4_1a_Caterpillar_body3');
        ...
        _this.Caterpillar_head= _this.add.sprite(_this.world.centerX+80,_this.world.centerY-75,'Unity2_4_1a_start');  
        _this.Caterpillar_head.name = "Unity2_4_1a_start";
        _this.Caterpillar_head.anchor.setTo(0.5);
        _this.Caterpillar_head.scale.setTo(0.6,0.6);
        
        _this.Neutral =_this.Caterpillar_head.animations.add('Unity2_4_1a_start');
        //_this.Caterpillar_head.animations.play('Unity2_4_1start', 30, true);
     
        _this.opt1 = _this.add.sprite(_this.world.centerX+250,_this.world.centerY-25, 'Unity2_4_1a_Tick');
        ...
        /************************end**********************/
        //drag body
        _this.Caterpillar_body_head_5= _this.add.sprite(_this.world.centerX-160,_this.world.centerY+160,'Unity2_4_1a_Caterpillar_Body1');
        ...
        _this.Caterpillar_body_head_6= _this.add.sprite(_this.world.centerX-70,_this.world.centerY+100,'Unity2_4_1a_Caterpillar_Body1');
        ...
        _this.Caterpillar_body_head_7= _this.add.sprite(_this.world.centerX+20,_this.world.centerY+160,'Unity2_4_1a_Caterpillar_Body1');
        ...
        _this.Caterpillar_body_head_8= _this.add.sprite(_this.world.centerX+110,_this.world.centerY+100,'Unity2_4_1a_Caterpillar_Body2');
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_4_1a_start', 30, true);
            },this);
        }
        else
        {
    ...
    gotoThirdQuestion:function()
    {
        ...
        _this.Caterpillar_body_head_6= _this.add.sprite(_this.world.centerX-70,_this.world.centerY+100,'Unity2_4_1a_Caterpillar_Body2');
        _this.Caterpillar_body_head_6.anchor.setTo(0.5);
        _this.Caterpillar_body_head_6.scale.setTo(0.7,0.7);
        _this.Caterpillar_body_head_6.name = '_this.Caterpillar_body_head_6';
        ...
        _this.Caterpillar_body_head_8= _this.add.sprite(_this.world.centerX+110,_this.world.centerY+100,'Unity2_4_1a_Caterpillar_Body1');
        _this.Caterpillar_body_head_8.anchor.setTo(0.5);
        _this.Caterpillar_body_head_8.scale.setTo(0.7,0.7);
        _this.Caterpillar_body_head_8.name = '_this.Caterpillar_body_head_8';
    ...
    gotoSixthQuestion:function()
    {
        ...
        _this.Caterpillar_body_head_7= _this.add.sprite(_this.world.centerX+20,_this.world.centerY+160,'Unity2_4_1a_Caterpillar_Body2');
        _this.Caterpillar_body_head_7.anchor.setTo(0.5);
        _this.Caterpillar_body_head_7.scale.setTo(0.7,0.7);
        _this.Caterpillar_body_head_7.name = '_this.Caterpillar_body_head_7';
	...
	correctAns:function(target)
	{
        ...
        if(correct)
        {
            ...
            if (_this.Caterpillar_head.key == 'Unity2_4_1a_start')
            {
                _this.Caterpillar_head.loadTexture('Unity2_4_1a_Caterpillar_Happy', 0);
                _this.Caterpillar_head.animations.add('Unity2_4_1a_Caterpillar_Happy');
                _this.Caterpillar_head.animations.play('Unity2_4_1a_Caterpillar_Happy',null,true);
            }
            ...
            _this.anim4 = _this.starAnim.animations.add('Unity2_4_1a_star');
            _this.anim4.play(); 
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'Unity2_4_1a_start')
            {
                ...
                _this.Caterpillar_head.loadTexture('Unity2_4_1a_wrong', 0);
                _this.Caterpillar_head.animations.add('Unity2_4_1a_wrong');
                _this.Caterpillar_head.animations.play('Unity2_4_1a_wrong',null,true);
            }
  ...
  /*  wrongAns:function(target)
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_4_1aScore');
        }
    },
