Game.unity2_1_2alevel1=function(){};


Game.unity2_1_2alevel1.prototype ={
    
    init:function(game)
    {
       _this= this;
       
       //telInitializer.gameIdInit("sequence2_1_2a",gradeSelected);
	...
	create:function(game){
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'unity2_1_2a_BG_01');
        _this.navBar = _this.add.sprite(0,0,'unity2_1_2_navBar');
        _this.navBar.scale.setTo(1,1);
        _this.backbtn = _this.add.button(5,5,'unity2_1_2_backbtn',function(){ 
        ...
        _this.speakerbtn = _this.add.sprite(600,5,'unity2_1_2_CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(300,5,'unity2_1_2_timebg');
       /* _this.topicOutline = _this.add.sprite(70,5,'unity2_1_2_topicOutline');
        _this.practice = _this.add.sprite(78,10,'unity2_1_2_practice');
        _this.topic = _this.add.sprite(200,10,'unity2_1_2_topic');*/
    ...
    {  
        ...
        _this.opt1 = _this.add.sprite(_this.world.centerX+280,_this.world.centerY-80, 'unity2_1_2a_Tick');
       ...
       // _this.opt1.frame = 1;
        ...
        _this.opt2 = _this.add.sprite(_this.world.centerX+280,_this.world.centerY+100, 'unity2_1_2a_Tick');
	...
	correctAns:function(target)
	{
       ...
       //telInitializer.tele_saveAssessment(_this.questionid,"yes",_this.AnsTimerCount,_this.noofAttempts,_this.sceneCount);
        ...
        {
             _this.Caterpillar_head.loadTexture('unity2_1_2a_Caterpillar_Happy', 0, false);
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_1_2aScore');
        }
    },
