Game.unity10_1_2level1=function(){};


Game.unity10_1_2level1.prototype={
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.counterForTimer = null;
             _this.stopVoice();
            _this.state.start('unity10_1_2Score');
        }
    },
		  ...
		  _this.src = document.createElement('source');
            switch( _this.qArrays[ _this.no1])
            {
                ...
                case 29:if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/English/Game 10.1.2.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Hindi/Game 10.1.2.mp3");
                        }
                        else if(window.languageSelected == "Kannada")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Kannada/Game 10.1.2.mp3");
                        }
						else
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Odiya/10.1.2.mp3");
