Game.unity2_3_1alevel1=function(){};

Game.unity2_3_1alevel1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Unity2_3_1aBG_01');
  ...
  /*  wrongAns:function(target)
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_3_1aScore');
        }
    },
    ...
    getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 6: if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.3.1/English/2.3.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.3.1/Hindi/2.3.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.3.1/Kannada/2.3.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/2.3.1/Odiya/2.3.1.mp3");
