Game.unity7_1_1level1=function(){};




Game.unity7_1_1level1.prototype={
	...
	create:function(game){
      ...
      // _this.speakerbtn.inputEnabled = true;
        ...
        _this.numBoxNum2 = _this.add.sprite(728,280,'Level321_numberSmall');
...
*/
    ...
    numDisplay:function(){
     ...
     //console.log("second num"+ Number(_this.assign+1));
        ...
        /*this.yellowcoin=this.add.sprite(0,0,'Level321_Coin1');
                            _this.Coin1 = _this.add.sprite(0,0,'Level321_Coin1');
    ...
    addNumberPad:function(){
        ...
        _this.eraser = _this.numGroup.create(_this.x+10,507,'Level321_erase');
        ...
        _this.rightbtn = _this.numGroup.create(_this.x+90,507,'Level321_rightmark');
		  ...
		  _this.src = document.createElement('source');
            switch( _this.qArrays[ _this.no1])
            {
                ...
                case 15:if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/English/Game 7.1.1.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Hindi/Game 7.1.1.mp3");
                        }
                        else if(window.languageSelected=="Kannada")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Kannada/Game 7.1.1.mp3");
                        }
						else
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Odiya/7.1.1.mp3");
