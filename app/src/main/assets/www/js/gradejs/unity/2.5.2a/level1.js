Game.unity2_5_2alevel1=function(){};

Game.unity2_5_2alevel1.prototype ={
    
    init:function(game)
    {
       _this= this;
       //telInitializer.gameIdInit("sequence2_5_2a",gradeSelected);
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Unity2_5_2aBG_01');
        
        _this.navBar = _this.add.sprite(0,0,'Unity2_5_2navBar');
        _this.navBar.scale.setTo(1,1);
        
        _this.backbtn = _this.add.button(5,5,'Unity2_5_2backbtn',function(){ 
        ...
        _this.speakerbtn = _this.add.sprite(600,5,'Unity2_5_2CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(300,5,'Unity2_5_2timebg');
       // _this.topicOutline = _this.add.sprite(70,5,'Unity2_5_2topicOutline');
        //_this.practice = _this.add.sprite(78,10,'Unity2_5_2practice');
        //_this.topic = _this.add.sprite(165,10,'Unity2_5_2topic');
       ...
       // _this.CaterpillarWhiteCopy.add(_this.Caterpillar_body_head_2Copy);
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_5_2astart', 30, true);
	...
	correctAns:function(target)
	{
        ...
        */
        ...
        if(_this.dragedTxt === _this.rightAns)
        {
            ...
            _this.anim4 = _this.starAnim.animations.add('Unity2_5_2astar');
            _this.anim4.play(); 
    ...
    getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 8: if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.5.2/English/2.5.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.5.2/Hindi/2.5.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.5.2/Kannada/2.5.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/2.5.2/Odiya/2.5.2.mp3");
