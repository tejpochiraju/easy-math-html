Game.unity2_5_1level1=function(){};

Game.unity2_5_1level1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Unity2_5_1BG_01');
        
        _this.navBar = _this.add.sprite(0,0,'Unity2_5_1navBar');
        _this.navBar.scale.setTo(1,1);
        
        _this.backbtn = _this.add.button(5,5,'Unity2_5_1backbtn',function(){ 
        ...
        _this.speakerbtn = _this.add.sprite(600,5,'Unity2_5_1CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(300,5,'Unity2_5_1timebg');
        /*_this.topicOutline = _this.add.sprite(70,5,'Unity2_5_1topicOutline');
        _this.practice = _this.add.sprite(78,10,'Unity2_5_1practice');
        _this.topic = _this.add.sprite(165,10,'Unity2_5_1topic');*/
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'Unity2_5_1starAnim');
			for(var j =0;j<i;j++)
			{
    ...
    onDragStart:function(target)
    {
       //console.log("onDragStart");
        ...
        target.events.onDragStop.add(function(target)
        {
            ...
            {
                if(_this.checkOverlap(target,_this.CaterpillarWhite.getChildAt(i)) && (_this.whiteGroup.getChildAt(i).key == 'Unity2_5_1Caterpillar_body3'))
                { 
    ...
    dragStop:function(target)
    {
        ...
        for(var i=0;i<_this.whiteGroup.length;i++)
        {
            ...
            { 
                ...
                target.loadTexture('Unity2_5_1Caterpillar_body3',0,false);
    ...
    {  
        ...
        _this.Caterpillar_body_head_1_1= _this.add.sprite(_this.world.centerX-68,_this.world.centerY-10,'Unity2_5_1Caterpillar_Body1');
        ...
        _this.Caterpillar_body_head_2_2= _this.add.sprite(_this.world.centerX+75,_this.world.centerY-10,'Unity2_5_1Caterpillar_Body1');
        ...
        //White color body
        _this.Caterpillar_body_head_1=_this.add.sprite(_this.world.centerX+2,_this.world.centerY-22,'Unity2_5_1Caterpillar_body3');
        _this.Caterpillar_body_head_1.anchor.setTo(0.5);
        _this.Caterpillar_body_head_1.scale.setTo(0.5,0.5);
           
        /***********************************Copy*****************************************/
        _this.Caterpillar_body_head_1Copy=_this.add.sprite(_this.world.centerX+2,_this.world.centerY-22,'Unity2_5_1Caterpillar_body3');
       ...
       // _this.CaterpillarWhiteCopy.add(_this.Caterpillar_body_head_2Copy);
        ...
        _this.Caterpillar_head= _this.add.sprite(_this.world.centerX-135,_this.world.centerY-75,'Unity2_5_1start');  
        _this.Caterpillar_head.name = "start";
        _this.Caterpillar_head.anchor.setTo(0.5);
        _this.Caterpillar_head.scale.setTo(0.6,0.6);
        
        _this.Neutral =_this.Caterpillar_head.animations.add('Unity2_5_1start');
        // _this.Caterpillar_head.animations.play('start', 30, true);
     
        _this.opt1 = _this.add.sprite(_this.world.centerX+250,_this.world.centerY-20, 'Unity2_5_1Tick');
        ...
        _this.Caterpillar_body_head_5= _this.add.sprite(_this.world.centerX-120,_this.world.centerY+175,'Unity2_5_1Caterpillar_Body1');
        ...
        _this.Caterpillar_body_head_6= _this.add.sprite(_this.world.centerX-15,_this.world.centerY+120,'Unity2_5_1Caterpillar_Body2');
        ...
        _this.Caterpillar_body_head_7= _this.add.sprite(_this.world.centerX+90,_this.world.centerY+175,'Unity2_5_1Caterpillar_Body2');
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_5_1start', 20, true);
    ...
    {                                  
       ...
       // _this.Caterpillar_head.animations.play('start', 30, true);
        ...
        _this.Caterpillar_body_head_5=_this.add.sprite(_this.world.centerX-120,_this.world.centerY+175,'Unity2_5_1Caterpillar_Body2');
        _this.Caterpillar_body_head_5.anchor.setTo(0.5);
        _this.Caterpillar_body_head_5.scale.setTo(0.5,0.5);
        _this.Caterpillar_body_head_5.name = '_this.Caterpillar_body_head_6';
        ...
        _this.Caterpillar_body_head_6=_this.add.sprite(_this.world.centerX-15,_this.world.centerY+120,'Unity2_5_1Caterpillar_Body1');
        //_this.Caterpillar_body_head_7= _this.add.sprite(_this.world.centerX+30,_this.world.centerY+155,'Caterpillar_Body1');
        _this.Caterpillar_body_head_6.anchor.setTo(0.5);
        _this.Caterpillar_body_head_6.scale.setTo(0.5,0.5);
        _this.Caterpillar_body_head_6.name = '_this.Caterpillar_body_head_7';
    ...
    gotoSixthQuestion:function()
    {
       ...
       // _this.Caterpillar_head.animations.play('start', 30, true);
        ...
        _this.Caterpillar_body_head_7=_this.add.sprite(_this.world.centerX+90,_this.world.centerY+175,'Unity2_5_1Caterpillar_Body1');
        _this.Caterpillar_body_head_7.anchor.setTo(0.5);
        _this.Caterpillar_body_head_7.scale.setTo(0.5,0.5);
        _this.Caterpillar_body_head_7.name = '_this.Caterpillar_body_head_6';
	...
	correctAns:function(target)
	{
        ...
        if(_this.dragedTxt === _this.rightAns)
        {
            ...
            _this.opt1.events.onInputUp.removeAll();
             ...
             if (_this.Caterpillar_head.key == 'Unity2_5_1start')
            {
                _this.Caterpillar_head.loadTexture('Unity2_5_1Caterpillar_Happy', 0);
                _this.Caterpillar_head.animations.add('Unity2_5_1Caterpillar_Happy');
                _this.Caterpillar_head.animations.play('Unity2_5_1Caterpillar_Happy',20,true);
            }
             //_this.wrong = true;
            ...
            _this.anim4 = _this.starAnim.animations.add('Unity2_5_1star');
            _this.anim4.play(); 
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'Unity2_5_1start')
            {
                ...
                _this.Caterpillar_head.loadTexture('Unity2_5_1wrong', 0);
                _this.Caterpillar_head.animations.add('Unity2_5_1wrong');
                _this.Caterpillar_head.animations.play('Unity2_5_1wrong',20,true);
            }
  ...
  /*  wrongAns:function(target)
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_5_1Score');
        }
    },
