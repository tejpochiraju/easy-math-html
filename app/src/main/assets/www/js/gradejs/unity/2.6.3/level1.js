...
create:function(game)
    {
        ...
        _this.backbtn = _this.add.button(10,7,'unity2_6_3_backbtn',function(){ 
        ...
        _this.speaker = _this.add.button(610,9,'unity2_6_3_speaker');
        ...
        _this.timerbg=_this.add.sprite(300,9,'unity2_6_3_timerbg');
 ...
 updateTimer:function() 
    ...
    generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			_this.starsGroup.create(_this.world.centerX-15, 13, 'unity2_6_3_starAnim');
			for(var j =0;j<i;j++)
			{
...
{         
 ...
 gotoTenthQuestion:function()
 {
        ...
        _this.text3 = _this.add.text(-80, -2, "366");
        _this.text3.font = "myfont";
        _this.text3.fill = "#ffffff";
        _this.text3.fontWeight = 'normal';
        _this.text3.anchor.set(0.5);
        ...
        _this.text4 = _this.add.text(0, 1, "367");
        _this.text4.font = "myfont";
        _this.text4.fill = "#ffffff";
        _this.text4.fontWeight = 'normal';
        _this.text4.anchor.set(0.5);
        ...
        _this.text11 = _this.add.text(0, 80, "368");
        _this.text11.font = "myfont";
        _this.text11.fill = "#ffffff";
        _this.text11.fontWeight = 'normal';
        _this.text11.anchor.set(0.5);
    ...
    getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10: if(window.languageSelected=="English")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.6.3/English/26.3E.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.6.3/Hindi/26.3H.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.6.3/Kannada/26.3K.mp3");
                    }
					else
                    {
                         _this.src.setAttribute("src", "questionSounds/2.6.3/Odiya/2.6.3.mp3");
