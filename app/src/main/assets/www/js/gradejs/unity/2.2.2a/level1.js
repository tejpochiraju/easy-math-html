Game.unity2_2_2alevel1=function(){};


Game.unity2_2_2alevel1.prototype ={
    
    init:function(game)
    {
       _this= this;
       
       //telInitializer.gameIdInit("sequence2_2_2a",gradeSelected);
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'unity2_2_2a_BG_01');
    ...
    {  
        ...
        _this.Caterpillar_head.animations.play('unity2_2_2a_start', 33, true);
        
     
        _this.opt1 = _this.add.sprite(_this.world.centerX+370,_this.world.centerY-10, 'unity2_2_2a_Tick');
...
//                
        ...
        if(correct)
        {
            ...
            {
                _this.Caterpillar_head.loadTexture('unity2_2_2a_Caterpillar_Happy', 0);
                _this.Caterpillar_head.animations.add('Unity2_2_2a_Caterpillar_Happy');
                _this.Caterpillar_head.animations.play('Unity2_2_2a_Caterpillar_Happy',null,true);
            }
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'unity2_2_2a_start')
            {
                _this.Caterpillar_head.loadTexture('unity2_2_2a_wrong', 0);
                _this.Caterpillar_head.animations.add('Unity2_2_2a_wrong');
                _this.Caterpillar_head.animations.play('Unity2_2_2a_wrong',null,true);
            }
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_2_2aScore');
        }
    },
