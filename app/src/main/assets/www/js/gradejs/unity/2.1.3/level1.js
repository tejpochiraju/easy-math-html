Game.unity2_1_3level1=function(){};


Game.unity2_1_3level1.prototype ={
	...
	create:function(game){
        ...
        _this.backbtn = _this.add.button(5,5,'unity2_1_3_backbtn',function(){ 
        ...
        _this.speakerbtn = _this.add.sprite(600,5,'unity2_1_3_CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(300,5,'unity2_1_3_timebg');
       ...
       /* _this.playQuestionSound = document.createElement('audio');
        ...
        {
            _this.src.setAttribute("src", "questionSounds/2.1.3/English/question2.1_Eng.mp3");
        }
        else if(window.languageSelected=="Hindi")
        {
            _this.src.setAttribute("src", "questionSounds/2.1.3/Hindi/question2.1_Hin.mp3");
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.src.setAttribute("src", "questionSounds/2.1.3/Kannada/question2.1_Kan.mp3");
        }
		else
        {
            _this.src.setAttribute("src", "questionSounds/2.1.3/Odiya/2.1.3.mp3");
        }
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'unity2_1_3_starAnim');
			for(var j =0;j<i;j++)
			{
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_1_3Score');
        }
