Game.unity2_3_3alevel1=function(){};

Game.unity2_3_3alevel1.prototype ={
    
    init:function(game)
    {
       _this= this;
       //telInitializer.gameIdInit("sequence2_3_3a_",gradeSelected);
    },
	...
	create:function(game)
    {
       ...
       _this.qArrays = _this.shuffle(_this.qArrays);
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Unity2_3_3a_BG_01');
        ...
        _this.timebg = _this.add.sprite(300,3,'Unity2_3_3timebg');
   ...
   gotoSixthQuestion:function()
	...
	correctAns:function(target)
	{
        ...
        {   
            ...
            _this.anim4 = _this.starAnim.animations.add('Unity2_3_3a_star');
            _this.anim4.play(); 
        }
        else
        {     
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_3_3aScore');
        }
    },
    ...
    getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 6: if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.3.3/English/2.3.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.3.3/Hindi/2.3.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.3.3/Kannada/2.3.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/2.3.3/Odiya/2.3.3.mp3");
