...
Game.unity4_2_1level1.prototype ={
	...
	create:function(game)
    {
      ...
      // _this.speakerbtn.inputEnabled = true;
        ...
        {
            _this.src.setAttribute("src", "questionSounds/4.2/English/4.2.mp3");
        }
        else if(window.languageSelected=="Hindi")
        {
            _this.src.setAttribute("src", "questionSounds/4.2/Hindi/4.2.mp3");
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.src.setAttribute("src", "questionSounds/4.2/Kannada/4.2.mp3");
        }
        else 
        {
            _this.src.setAttribute("src", "questionSounds/4.2/Odiya/4.2.mp3");
