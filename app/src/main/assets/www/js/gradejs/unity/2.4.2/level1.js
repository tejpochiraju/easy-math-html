Game.unity2_4_2level1=function(){};

Game.unity2_4_2level1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.background = this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Unity2_4_2BG_01');
        
        _this.navBar = this.add.sprite(0,0,'Unity2_4_2navBar');
        _this.navBar.scale.setTo(1,1);
        
        _this.backbtn = this.add.button(5,5,'Unity2_4_2backbtn',function(){ 
        ...
        _this.timebg = this.add.sprite(300,5,'Unity2_4_2timebg');
        /*_this.topicOutline = this.add.sprite(70,5,'Unity2_4_2topicOutline');
        _this.practice = this.add.sprite(78,10,'Unity2_4_2practice');
        _this.topic = this.add.sprite(165,10,'Unity2_4_2topic');*/
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'Unity2_4_2starAnim');
			for(var j =0;j<i;j++)
			{
    ...
    {  
        ...
        //_this.Caterpillar_head.animations.play('Unity2_4_2start', 30, true);
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_4_2start', 20, true);
