Game.unity2_4_3alevel1=function(){};

Game.unity2_4_3alevel1.prototype ={
    
    init:function(game)
    {
        _this= this;
        //telInitializer.gameIdInit("sequence2_4_3a",gradeSelected);
    },
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Unity2_4_3a_BG_01');
        
        _this.navBar = _this.add.sprite(0,0,'Unity2_5_3navBar');
        _this.navBar.scale.setTo(1,1);
        
        _this.backbtn = _this.add.button(5,5,'Unity2_5_3backbtn',function(){ 
        ...
        _this.speakerbtn = _this.add.sprite(600,5,'Unity2_5_3CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(300,5,'Unity2_5_3timebg');
       /* _this.topicOutline = _this.add.sprite(70,5,'Unity2_5_3topicOutline');
        ...
        {
            _this.src.setAttribute("src", "questionSounds/2.5.3/English/2.5.mp3");
        }
        else if(window.languageSelected=="Hindi")
        {
            _this.src.setAttribute("src", "questionSounds/2.5.3/Hindi/2.5.mp3");
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.src.setAttribute("src", "questionSounds/2.5.3/Kannada/2.5.mp3");
        }
        else 
        {
            _this.src.setAttribute("src", "questionSounds/2.5.3/Odiya/2.5.3.mp3");
        }
    ...
    {  
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_4_3a_start', 30, true);
            },this);
        }
        else
        {
	...
	correctAns:function(target)
	{
        ...
        if(correct)
        {
            ...
            _this.anim4 = _this.starAnim.animations.add('Unity2_4_3a_star');
            _this.anim4.play(); 
  ...
  /*  wrongAns:function(target)
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_4_3aScore');
        }
    },
    ...
    getVoice:function()
    {
        ...
        switch(1)
        {
            ...
            case 8: if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.4.3/English/2.4.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.4.3/Hindi/2.4.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                        _this.src.setAttribute("src", "questionSounds/2.4.3/Kannada/2.4.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/2.4.3/Odiya/2.4.3.mp3");
