Game.unity7_2_3level1=function(){};
var randarr;
var yellowCoinArray;
var coinset;
var grpdrag;
Game.unity7_2_3level1.prototype={
	...
	create:function(game){
		...
		_this.physics.setBoundsToWorld();
           ...
           _this.bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level723_bg1');
            _this.navBar = _this.add.sprite(0,0,'Level723_navBar');
             _this.navBar.scale.setTo(1,1);
             _this.timebg = _this.add.sprite(300,6,'Level723_timebg');
             /*_this.topicOutline = _this.add.sprite(70,5,'Level723_topicOutline');
             _this.practice = _this.add.sprite(78,10,'Level723_practice');
       ...
       _this.backbtn = _this.add.sprite(5,5,'Level723_CommonBackBtn');
       ...
       _this.speakerbtn = _this.add.sprite(600,5,'Level723_CommonSpeakerBtn');
      // _this.speakerbtn.inputEnabled = true;
        ...
        _this.Levercoin10s = _this.add.sprite(309,160,'Level723_coin10Anim');
        _this.Levercoin10s.visible = false; 
        _this.Levercoin100 = _this.add.sprite(120,220,'Level723_coin100Anim');
      ...
      //      _this.askNumber4.scale.setTo(1.3,1.3);
       ...
       //  _this.askNumber5.scale.setTo(1.3,1.3);
        ...
        _this.numBoxNum3.visible = false;
         ...
         //_this.yellowcoin=this.add.sprite(0,0,'Level723_Coin1');
          //      _this.yellowcoin.visible=true;
        _this.Level721_OneToHundred1 = _this.add.sprite(124,62,'Level723_OneToHundred');
        _this.Level721_OneToHundred10 = _this.add.sprite(304,62,'Level723_OneToHundred');//304,55
        _this.Level721_OneToHundred10.frame = 1;
        _this.Level721_OneToHundred100 = _this.add.sprite(484,62,'Level723_OneToHundred');
    ...
    {  //console.log("get Question "+_this.no1);
     ...
     _this.greencoin=_this.add.sprite(0,0,'Level723_Coin100');
      ...
      //  _this.speakerbtn.input.useHandCursor = true;
       ...
       // _this.checkAns = Number(_this.Ans1)+Number(_this.Ans2);
        
       /* if(_this.checkAns < 100){
            _this.checkno = 100 - _this.checkAns;
     ...
     //console.log("first blue num"+ Number(_this.assign3));
     //console.log("second blue num"+ Number(_this.assign4));
     //console.log("first green num"+ Number(_this.assign5));
     //console.log("second green num"+ Number(_this.assign6));
  ...
  inputDownFunctionForLeverAndBox:function(){
      ...
      //_this.Coin1.frame=7;
      _this.Coin10 = _this.add.sprite(305,210,'Level723_Coin10');//350,210
      _this.Coin10.visible = false;
      
      _this.Coin10s = _this.add.sprite(309,210,'Level723_Coin10');//330,145
      _this.Coin10s.visible = false;
      
      _this.Coin100 = _this.add.sprite(130,210,'Level723_Coin100');//330,145
            ...
            if(_this.YellowAnimInc<_this.displayNumber2)
            {
                ...
                _this.Coin1.frame =  _this.YellowAnimInc;
                        ...
                        tween4.onComplete.add(function(){
                            ...
                            _this.newcoinset=_this.add.sprite(420,209,'Level723_Coin1','Symbol 15 copy 2 instance 10009');
    ...
    levelBlueClicked:function(target,frame){
         ...
         //  if(_this.LeverBlueNumber.frame==_this.displayNumber4 || _this.BlueAnimInc<_this.displayNumber4)
                 if((_this.BlueAnimInc<_this.displayNumber4 && coinset==null) || (_this.BlueAnimInc<=_this.displayNumber4 && coinset=="full"))
            {
               ...
               // if((Number(_this.displayNumber3) + Number(_this.LeverBlueNumber.frame) < 10) || (_this.displayNumber3 + _this.BlueAnimInc < 9)){
                ...
                if(_this.displayNumber3 + _this.BlueAnimInc == 9){
                    ...
                    _this.coinFall.play();
                    _this.Levercoin10.visible = true;
                    _this.Levercoin10.animations.add('Level723_coin1Anim',_this.animArrayCoin1);
                    ...
                    _this.BlueAnimInc++;
                      ...
                      //  tween3.to({ x: 319 }, 0, 'Linear', true, 0);
                        ...
                        tween4.onComplete.add(function(){
                            ...
                            _this.newcoinset=_this.add.sprite(239,210,'Level723_Coin10','Symbol 15 copy 4 instance 10009');
                            _this.newcoinset.inputEnabled=true;
            ...
            //if((_this.displayNumber3 + _this.BlueAnimInc > 9) || (_this.displayNumber3 + (_this.LeverBlueNumber.frame) > 10)){
               ...
               // if(_this.displayNumber3 + _this.BlueAnimInc > 9){
                ...
                _this.Levercoin10s.animations.add('Level723_coin10Anim',_this.animArrayCoin1);
            ...
            else if((_this.BlueAnimInc1 == (Number(_this.assign4) ) ) || (_this.BlueAnimInc1 == (_this.displayNumber3+_this.displayNumber4)-10) ){
               console.log("ggggg");
              //  _this.coinFall.stop();
                _this.LeverGreenanim =_this.LeverGreen.animations.add('Level722_LeverGreen',["Symbol 20 instance 10005","Symbol 20 instance 10000"]);
                    _this.LeverGreenanim.play(2,true);
       ...
       _this.LeverGreen.events.onInputDown.add(_this.leverGreenClicked,_this);
            ...
            /* if(_this.BlueAnimInc1 == (Number(_this.assign4)-1 ) && _this.zeroalready==0 && _this.already10==0 ){
                 if(Number(_this.assign4)-1 == 0){
                     _this.zeroalready=1;
                 }
                 _this.coinFall.stop();
            //console.log("dmm");
            ...
            else if(_this.BlueAnimInc1 > (Number(_this.assign4)-1 )){
             _this.LeverBlue.inputEnabled=false;
            _this.lessthanb=2;
        }*/
            }
    ...
    leverGreenClicked:function(target,frame){
        ...
        if(target.name == "LeverGreen"){
            ...
            // if(_this.GreenAnimInc == (Number(_this.assign6) ) || (_this.bluecarry==0 && _this.GreenAnimInc == (Number(_this.assign6) )))
            
            /*if(_this.bluecarry==1){
               _this.compare = (Number(_this.assign6) );
            }else{
                _this.compare = (Number(_this.assign6)-1 );
            }*/
            ...
            if(_this.selectedAns== _this.rightAns)  
                ...
                { 
                   ...
                   // _this.LeverBlueNumber.destroy();
                    ...
                    _this.bluecoin=_this.add.sprite(0,0,'Level723_Coin10');
                    _this.bluecoin.visible=true;
                    if(_this.LeverBlue){
                        _this.LeverBlue.destroy();
                    }
                    _this.LeverBlue = _this.add.sprite(290,67,'Level723_LeverBlue');
                    _this.LeverBlue.name = "LeverBlue";
                    _this.LeverBlueNumber.destroy();
                   
                    _this.LeverBlueNumber = _this.add.sprite(309,99,'Level723_numberVSmall');
                    _this.LeverBlueNumber.frame = 0;
  ...
  return array;
    ...
    removeEverthing:function() 
    {
       ...
       _this.yellowcoin.destroy();
        ...
        else
        {
            ...
            _this.state.start('unity7_2_3Score');
        }
    },
    ...
    generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			 ...
			 _this.starsGroup.create(_this.world.centerX-15, 10, 'Level723_starAnim');
    ...
    getVoice:function(){
        ...
        {
            _this.src.setAttribute("src", "questionSounds/7.2.3/English/Game 7.2.3.mp3");
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.src.setAttribute("src", "questionSounds/7.2.3/Hindi/Game 7.2.3.mp3");
        }
        else if(window.languageSelected == "Kannada")
        {
            _this.src.setAttribute("src", "questionSounds/7.2.3/Kannada/Game 7.2.3.mp3");
        }
		else
        {
            _this.src.setAttribute("src", "questionSounds/3.2.1/Odiya/7.2.3.mp3");
                    ...
                    _this.glow.width+=10;
                      ...
                      //  tween3.to({ x: 319 }, 0, 'Linear', true, 0);
                        ...
                        tween4.onComplete.add(function(){
                            _this.Coin10.visible=false;
                            _this.bluecoin.visible=false;
                            _this.newcoinset=_this.add.sprite(250,210,'Level723_Coin10','Symbol 15 copy 4 instance 10009');
                            _this.newcoinset.inputEnabled=true;
                            _this.newcoinset.name="dragbluecoin";
                            _this.newcoinset.input.enableDrag(true);
                            _this.newcoinset.events.onDragStart.add(this.onDragStart, this);
               ...
               if(target.name==_this.insertbox1.name)
                {
                    ...
                    _this.glow.destroy();
                    _this.newcoinset.destroy();
                    var bluecoinreverse = this.add.sprite(239,145,'Level723_bluecoinreverse','Symbol 15 copy 9 instance 10000');
