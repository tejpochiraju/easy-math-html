Game.unity2_5_2level1=function(){};

Game.unity2_5_2level1.prototype ={
       ...
       // _this.CaterpillarWhiteCopy.add(_this.Caterpillar_body_head_2Copy);
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_5_2start', 20, true);
	...
	correctAns:function(target)
	{
        ...
        */
        ...
        if(_this.dragedTxt === _this.rightAns)
        {
            ...
            _this.anim4 = _this.starAnim.animations.add('Unity2_5_2star');
            _this.anim4.play(); 
