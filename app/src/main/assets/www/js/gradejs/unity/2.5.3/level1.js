Game.unity2_5_3level1=function(){};

Game.unity2_5_3level1.prototype ={
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'Unity2_5_3starAnim');
			for(var j =0;j<i;j++)
			{
	...
	correctAns:function(target)
	{
        ...
        */
        ...
        if(_this.dragedTxt === _this.rightAns)
        {
            ...
            _this.anim4 = _this.starAnim.animations.add('Unity2_5_3star');
            _this.anim4.play(); 
  ...
  /*  wrongAns:function(target)
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_5_3Score');
        }
    },
