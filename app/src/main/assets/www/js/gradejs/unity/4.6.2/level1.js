Game.unity4_6_2level1=function(){};

Game.unity4_6_2level1.prototype={
    init:function(game)
    {
       _this = this;
...
create:function(game)
    {
        ...
        _this.speaker = _this.add.button(610,9,'grade11_speaker');
       ...
       /* _this.dotbox=_this.add.sprite(70,7,'unity4_6_2dotbox');
 ...
 gotoFirstQuestion:function()
    {
       // _this.getVoice();
        ...
        _this.number6.frame=4;
        _this.number6.value=5;
...
gotoSecondQuestion:function()
    {
       // _this.getVoice();
        ...
        _this.number4.anchor.setTo(0.5);
        _this.number4.scale.setTo(0.9,0.95);
        _this.number4.frame=1;
        _this.number4.value=2;
        _this.number4.name = "number4";
        _this.number4.inputEnabled = true;
        _this.number4.input.useHandCursor = true;
        _this.number4.events.onInputDown.add(_this.onDragStart,_this);
        ...
        _this.no11++;
		  ...
		  if(_this.no11<6)
                ...
                else
                    {
                        ...
                        _this.timer1.stop();
                         _this.timer1=null;
                         _this.state.start('unity4_6_2Score');
                    }
    ...
    getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10: if(window.languageSelected=="English")
                    {
                         _this.src.setAttribute("src", "questionSounds/4.6.2/English/46.1E.mp3");
                    }
                    else if(window.languageSelected=="hindi")
                    {
                         _this.src.setAttribute("src", "questionSounds/4.6.2/Hindi/46.1H.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                         _this.src.setAttribute("src", "questionSounds/4.6.2/Kannada/46.1K.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/4.6.2/Odiya/4.6.2.mp3");
