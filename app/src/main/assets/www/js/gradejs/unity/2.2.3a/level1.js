Game.unity2_2_3alevel1=function(){};


Game.unity2_2_3alevel1.prototype ={
    
    init:function(game)
    {
       _this= this;
       
       //telInitializer.gameIdInit("sequence2_2_3a",gradeSelected);
	...
	create:function(game)
    {
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'unity2_2_3a_BG_01');
    ...
    onDragStart:function(target)
    {
       //console.log("onDragStart");
        ...
        { 
            ...
            event_type: "drag", 
            res_id: "level2.2.3a_"+target.name, 
        ...
        target.events.onDragStop.add(function(target)
        {
            ...
            {
                if(_this.checkOverlap(target,_this.CaterpillarWhite.getChildAt(i)) && (_this.whiteGroup.getChildAt(i).key == 'unity2_2_3a_Caterpillar_body3'))
                { 
    ...
    dragStop:function(target)
    {
        ...
        for(var i=0;i<_this.whiteGroup.length;i++)
        {
            ...
            { 
                ...
                target.loadTexture('unity2_2_3a_Caterpillar_body3',0,false);
    ...
    {  
        ...
        _this.Caterpillar_body_head_1= _this.add.sprite(_this.world.centerX-160,_this.world.centerY-12,'unity2_2_3a_Caterpillar_body3');
        _this.Caterpillar_body_head_1.anchor.setTo(0.5);
        _this.Caterpillar_body_head_1.scale.setTo(0.8,0.8);
       
        _this.Caterpillar_body_head_2= _this.add.sprite(_this.world.centerX-85,_this.world.centerY-27,'unity2_2_3a_Caterpillar_body3');
        _this.Caterpillar_body_head_2.anchor.setTo(0.5);
        _this.Caterpillar_body_head_2.scale.setTo(0.8,0.8);
        
        _this.Caterpillar_body_head_3= _this.add.sprite(_this.world.centerX-10,_this.world.centerY-28,'unity2_2_3a_Caterpillar_body3');
        _this.Caterpillar_body_head_3.anchor.setTo(0.5);
        _this.Caterpillar_body_head_3.scale.setTo(0.8,0.8);
        
        _this.Caterpillar_body_head_4= _this.add.sprite(_this.world.centerX+65,_this.world.centerY-35,'unity2_2_3a_Caterpillar_body3');
        _this.Caterpillar_body_head_4.anchor.setTo(0.5);
        _this.Caterpillar_body_head_4.scale.setTo(0.8,0.8);
        
        /***********************************Copy*****************************************/
        _this.Caterpillar_body_head_1Copy= _this.add.sprite(_this.world.centerX-160,_this.world.centerY-12,'unity2_2_3a_Caterpillar_body3');
        _this.Caterpillar_body_head_1Copy.anchor.setTo(0.5);
        _this.Caterpillar_body_head_1Copy.scale.setTo(0.8,0.8);
       
        _this.Caterpillar_body_head_2Copy= _this.add.sprite(_this.world.centerX-85,_this.world.centerY-27,'unity2_2_3a_Caterpillar_body3');
        _this.Caterpillar_body_head_2Copy.anchor.setTo(0.5);
        _this.Caterpillar_body_head_2Copy.scale.setTo(0.8,0.8);
        
        _this.Caterpillar_body_head_3Copy= _this.add.sprite(_this.world.centerX-10,_this.world.centerY-28,'unity2_2_3a_Caterpillar_body3');
        _this.Caterpillar_body_head_3Copy.anchor.setTo(0.5);
        _this.Caterpillar_body_head_3Copy.scale.setTo(0.8,0.8);
        
        _this.Caterpillar_body_head_4Copy= _this.add.sprite(_this.world.centerX+65,_this.world.centerY-35,'unity2_2_3a_Caterpillar_body3');
        ...
        _this.Caterpillar_head= _this.add.sprite(_this.world.centerX+155,_this.world.centerY-78,'unity2_2_3a_start');  
        _this.Caterpillar_head.name = "start";
        _this.Caterpillar_head.anchor.setTo(0.5);
        _this.Caterpillar_head.scale.setTo(0.6,0.6);
        
        _this.Neutral =_this.Caterpillar_head.animations.add('unity2_2_3a_start');
        _this.Caterpillar_head.animations.play('unity2_2_3a_start', 33, true);
        
     
        _this.opt1 = _this.add.sprite(_this.world.centerX+370,_this.world.centerY-10, 'unity2_2_3a_Tick');
        ...
        _this.Caterpillar_body_head_5= _this.add.sprite(_this.world.centerX-170,_this.world.centerY+130,'unity2_2_3a_Caterpillar_Body1');
        ...
        _this.Caterpillar_body_head_6= _this.add.sprite(_this.world.centerX-55,_this.world.centerY+130,'unity2_2_3a_Caterpillar_Body2');
        ...
        _this.Caterpillar_body_head_7= _this.add.sprite(_this.world.centerX+60,_this.world.centerY+130,'unity2_2_3a_Caterpillar_Body1');
        ...
        _this.Caterpillar_body_head_8= _this.add.sprite(_this.world.centerX+180,_this.world.centerY+130,'unity2_2_3a_Caterpillar_Body2');
    ...
    gotoThirdQuestion:function()
    {
       ...
       // _this.opt1.frame=1;
        ...
        _this.text = _this.add.text(0, 0, "130");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "127");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "128");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "129");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoFourthQuestion:function()
    {
        ...
        _this.text = _this.add.text(0, 0, "289");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "288");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "291");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "290");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoFifthQuestion:function()
    {
        ...
        _this.text = _this.add.text(0, 0, "642");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "643");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "644");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "641");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoSixthQuestion:function()
    {
       ...
       // _this.opt1.frame=1;
        ...
        _this.text = _this.add.text(0, 0, "934");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "937");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "936");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoEighthQuestion:function()
    {
        ...
        _this.text = _this.add.text(0, 0, "742");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "739");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "740");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "741");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    gotoNinethQuestion:function()
    {
        ...
        _this.text = _this.add.text(0, 0, "829");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "826");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "827");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
        ...
        _this.text = _this.add.text(0, 0, "828");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
    ...
    {                                  
        ...
        _this.text = _this.add.text(0, 0, "377");
        _this.text.font = "myfont";
        _this.text.fill = "#ffffff";
        _this.text.fontWeight = 'normal';
        _this.text.anchor.set(0.5);
...
//                
        ...
        if(correct)
        {
            ...
            //Correct answer here
            if (_this.Caterpillar_head.key == 'unity2_2_3a_start')
            {
                _this.Caterpillar_head.loadTexture('unity2_2_3a_Caterpillar_Happy', 0);
                _this.Caterpillar_head.animations.add('Unity2_2_3a_Caterpillar_Happy');
                _this.Caterpillar_head.animations.play('Unity2_2_3a_Caterpillar_Happy',null,true);
            }
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'unity2_2_3a_start')
            {
                _this.Caterpillar_head.loadTexture('unity2_2_3a_wrong', 0);
                _this.Caterpillar_head.animations.add('Unity2_2_3a_wrong');
                _this.Caterpillar_head.animations.play('Unity2_2_3a_wrong',null,true);
            }
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_2_3aScore');
        }
    },
