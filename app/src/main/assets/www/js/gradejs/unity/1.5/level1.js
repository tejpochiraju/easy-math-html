...
Game.unity1_5level1.prototype={
	...
	create:function(game){
		...
		_this.physics.setBoundsToWorld();
           ...
           _this.bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'unity15_bg1');
            _this.navBar = _this.add.sprite(0,0,'unity15_navBar');
             ...
             _this.timebg = _this.add.sprite(300,5,'unity15_timebg');
       ...
       _this.backbtn = _this.add.sprite(5,5,'unity15_CommonBackBtn');
       ...
       _this.speakerbtn = _this.add.sprite(600,5,'unity15_CommonSpeakerBtn');
