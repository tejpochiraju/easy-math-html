Game.unity2_1_1level1=function(){};


Game.unity2_1_1level1.prototype ={
	...
	create:function(game){
        ...
        /*_this.topicOutline = _this.add.sprite(70,5,'unity2_1_1_topicOutline');
        _this.practice = _this.add.sprite(78,10,'unity2_1_1_practice');
        _this.topic = _this.add.sprite(200,10,'unity2_1_1_topic');*/
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'unity2_1_1_starAnim');
			for(var j =0;j<i;j++)
			{
	...
	correctAns:function(target)
	{
       ...
       telInitializer.tele_saveAssessment(_this.questionid,"yes",_this.AnsTimerCount,_this.noofAttempts,_this.sceneCount);
        ...
        /*if(_this.Caterpillar_head.key === 'Caterpillar_Neutral')
        {
            _this.Caterpillar_head.loadTexture('Caterpillar_Happy', 0, false);
        }*/
