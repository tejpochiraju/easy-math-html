...
create:function(game)
    {
       ...
       _this.qArrays = _this.shuffle(_this.qArrays);
        ...
        _this.backbtn = _this.add.button(10,7,'unity2_6_1_backbtn',function(){ 
        ...
        _this.speaker = _this.add.button(610,9,'unity2_6_1_speaker');
        ...
        _this.timerbg=_this.add.sprite(300,9,'unity2_6_1_timerbg');
 ...
 updateTimer:function() 
    ...
    generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			_this.starsGroup.create(_this.world.centerX-15, 13, 'unity2_6_1_starAnim');
			for(var j =0;j<i;j++)
			{
    ...
    getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10: if(window.languageSelected=="English")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.6.1/English/26.1E.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.6.1/Hindi/26.1H.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.6.1/Kannada/26.1K.mp3");
                    }
					else
                    {
                         _this.src.setAttribute("src", "questionSounds/2.6.1/Odiya/2.6.1.mp3");
