...
Game.unity17_3level1.prototype={
     ...
     init:function(game)
    {
        ...
        _this.gameid = "17.3";
        telInitializer.gameIdInit("Unity17_3",gradeSelected);
...
counted1=0;
  ...
  addYellowCoins:function(){
    ...
    addNumberPad:function(){
        ...
        //objGroup.add(txtbox);
        var wrongbtn = numGroup.create(x+10,508,'eraser');
