Game.unity2_2_2level1=function(){};


Game.unity2_2_2level1.prototype ={
	...
	create:function(game)
    {
       ...
       _this.qArrays = _this.shuffle(_this.qArrays);
        ...
        _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'unity2_2_2_BG_01');
        ...
        /*_this.topicOutline = _this.add.sprite(70,5,'unity2_2_2_topicOutline');
        _this.practice = _this.add.sprite(78,10,'unity2_2_2_practice');
        _this.topic = _this.add.sprite(200,10,'unity2_2_2_topic');*/
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'unity2_2_2_starAnim');
			for(var j =0;j<i;j++)
			{
    ...
    {  
        ...
        _this.Caterpillar_head.animations.play('unity2_2_2_start', 20, true);
     
        _this.opt1 = _this.add.sprite(_this.world.centerX+370,_this.world.centerY-10, 'unity2_2_2_Tick');
...
//                
        ...
        if(correct)
        {
           ...
           if (_this.Caterpillar_head.key == 'unity2_2_2_start')
            {
                _this.Caterpillar_head.loadTexture('unity2_2_2_Caterpillar_Happy', 0);
                _this.Caterpillar_head.animations.add('Unity2_2_2Caterpillar_Happy');
                _this.Caterpillar_head.animations.play('Unity2_2_2Caterpillar_Happy',20,true);
            }
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'unity2_2_2_start')
            {
                _this.Caterpillar_head.loadTexture('unity2_2_2_wrong', 0);
                _this.Caterpillar_head.animations.add('Unity2_2_2wrong');
                _this.Caterpillar_head.animations.play('Unity2_2_2wrong',20,true);
            }
   ...
   /* wrongAns:function(target)
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('unity2_2_2Score');
        }
    },
