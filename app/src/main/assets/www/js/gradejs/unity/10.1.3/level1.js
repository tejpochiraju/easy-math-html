Game.unity10_1_3level1=function(){};


Game.unity10_1_3level1.prototype={
    ...
    removeEverthing:function() 
    {
        ...
        else
        {
            ...
            _this.counterForTimer = null;
             _this.stopVoice();
            _this.state.start('unity10_1_3Score');
        }
    },
		  ...
		  _this.src = document.createElement('source');
            switch( _this.qArrays[ _this.no1])
            {
                ...
                case 33:if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/English/Game 10.1.3.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Hindi/Game 10.1.3.mp3");
                        }
                        else if(window.languageSelected == "Kannada")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Kannada/Game 10.1.3.mp3");
                        }
						else
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Odiya/10.1.3.mp3");
