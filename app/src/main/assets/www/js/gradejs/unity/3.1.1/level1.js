Game.unity3_1_1level1=function(){};
Game.unity3_1_1level1.prototype={
init:function(game)
    {
        _this = this;
	...
	create:function(game){
      ...
      // _this.speakerbtn.inputEnabled = true;
       ...
       /* _this.coinYellow = _this.add.sprite(353,250,'Level321_Coin1');
        _this.coinYellow.frame = 5;

         _this.coinGreen = _this.add.sprite(518,250,'Level321_Coin10');
          ...
          /*  switch( _this.qArrays[ _this.no1])
            {
                ...
                case 15:*/if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/English/Game 3.2.1.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Hindi/Game 3.2.1.mp3");
                        }
                        else if(window.languageSelected == "Kannada")
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Kannada/Game 3.2.1.mp3");
                        }
						else
                        {
                            _this.src.setAttribute("src", "questionSounds/3.2.1/Odiya/3.2.1.mp3");
