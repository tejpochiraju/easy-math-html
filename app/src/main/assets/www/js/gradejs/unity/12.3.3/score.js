Game.unity12_3_3Score=function(game){

};

Game.unity12_3_3Score.prototype={
	create:function(game){
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
			...
			if(grade2Selected == true)
				_this.state.start('grade15_1level1',true,false); 
			else
				_this.state.start('grade17_2level1',true,false);
